...
var file_order_proto_rawDesc = []byte{
	...
	0x3f, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x2f, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x69, 0x6e, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x4d, 0x61, 0x69, 0x6e, 0x52, 0x09, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x69, 0x6e,
	...
	0x61, 0x67, 0x65, 0x32, 0x5e, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x55, 0x0a, 0x08,
	0x4e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x13, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_order_proto_goTypes = []interface{}{
	...
	(*OrderMain)(nil),     // 2: proto.OrderMain
}
var file_order_proto_depIdxs = []int32{
	2, // 0: proto.OrderRequest.order_main:type_name -> proto.OrderMain
	0, // 1: proto.Order.NewOrder:input_type -> proto.OrderRequest
	1, // 2: proto.Order.NewOrder:output_type -> proto.OrderResponse
...
func (c *orderClient) NewOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	out := new(OrderResponse)
	err := c.cc.Invoke(ctx, "/proto.Order/NewOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedOrderServer) NewOrder(context.Context, *OrderRequest) (*OrderResponse, error) {
...
func _Order_NewOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Order/NewOrder",
	}
